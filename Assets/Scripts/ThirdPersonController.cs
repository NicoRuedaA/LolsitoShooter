...
namespace StarterAssets{
    ...
    /*public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _animator = transform.Find("Geometry").Find("jax").GetComponent<Animator>();
        ...
        private void Update()
        {
            ...
            if (_input.habilitie1){
                _animator.SetBool(_animIDAttacking, true);
                //_animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(1), 1f, Time.deltaTime*10f));
                //Debug.Log("tecla 1 pulsada");
                _animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(2), 1f, Time.deltaTime*10f));
                _animator.Play("jaxQ", 2);
            }
            
            if (_input.habilitie2){
                //_animator.SetBool(_animIDAttacking, true);
                //_animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(1), 1f, Time.deltaTime*10f));
                //Debug.Log("tecla 1 pulsada");
                _animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(2), 1f, Time.deltaTime*10f));
                _animator.Play("jaxW", 2);
            }
            if (_input.habilitie3){
                //_animator.SetBool(_animIDAttacking, true);
                //_animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(1), 1f, Time.deltaTime*10f));
                //Debug.Log("tecla 1 pulsada");
                _animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(2), 1f, Time.deltaTime*10f));
                _animator.Play("jaxE", 2);
            }
            
            if (_input.habilitie4){
                //_animator.SetBool(_animIDAttacking, true);
                //_animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(1), 1f, Time.deltaTime*10f));
                //Debug.Log("tecla 1 pulsada");
                _animator.SetLayerWeight(2, Mathf.Lerp(_animator.GetLayerWeight(2), 1f, Time.deltaTime*10f));
                _animator.Play("jaxR", 2);
            }
            
            
            
            else _animator.SetBool(_animIDAttacking, false);
        ...
        public void endHabilitie(){
            Debug.Log("se acabo");
            _input.habilitie1 = false;
